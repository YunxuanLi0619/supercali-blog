...
Tool-use is where most of the reliability work in agent systems actually lives. This picks up on the "narrow tool surface" point from [[on-building-with-llms|On building with LLMs]] — a few things that have held up across projects:
